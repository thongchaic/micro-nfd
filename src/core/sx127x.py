...
class SX127x:
    ...
    # frfs = {9232E6: (0xe6, 0xCC, 0xF4),
    #         9234E6: (0xe6, 0xD9, 0xC0),
    #         9236E6: (0xe6, 0xe6, 0x66),
    #         9238E6: (0xe6, 0xf3, 0x33),
    #         9240E6: (0xe7, 0x00, 0x00),
    #         9242E6: (0xe7, 0x0C, 0xCC),
    #         9244E6: (0xe7, 0x19, 0x99),
    #         9246E6: (0xe7, 0x26, 0x66)}
    ...
    def set_frequency(self, frequency, freq_table=frfs):
        ...
        if __DEBUG__:
            ...
            print(freq_table)
            print("setting MSB:[",REG_FRF_MSB,"]",freq_table[frequency][0])
            print("setting MID:[",REG_FRF_MID,"]",freq_table[frequency][1])
            print("setting LSB:[",REG_FRF_LSB,"]",freq_table[frequency][2])
